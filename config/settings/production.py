...
ALLOWED_HOSTS = env.list(
    "DJANGO_ALLOWED_HOSTS", default=["studentperformance.com"]
)
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Student Performance <noreply@studentperformance.com>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    "DJANGO_EMAIL_SUBJECT_PREFIX", default="[Student Performance]"
)
